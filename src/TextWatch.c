...
static void init() {
  ...
  window_set_background_color(window, GColorBlack);
	...
	lightFont = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_GOTHAM_LIGHT_26));
	boldFont = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_GOTHAM_BOLD_28));

	line1.currentLayer = text_layer_create(GRect(0, 30, 144, 50));
	line1.nextLayer = text_layer_create(GRect(144, 30, 144, 50));
